"""Internal utilities - centralized to avoid duplication (Ponytail principle).

This module consolidates commonly duplicated utility functions to follow the
DRY (Don't Repeat Yourself) principle and Ponytail's "one line before fifty" guideline.

ponytail: Consolidated from 52 files with duplicate implementations.
"""
