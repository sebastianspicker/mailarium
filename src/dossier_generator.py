...
class DossierGenerator:
    ...
    def _compute_summary_stats(
        ...
        categories, category_breakdown, glossary_items = DossierGenerator._summary_categories(enriched_items)
    ...
    @staticmethod
    def _summary_categories(items: list[dict[str, Any]]) -> tuple[set[Any], list[dict[str, str]], list[dict[str, str]]]:
        ...
        glossary = [
            {"category": category, "definition": CATEGORY_GLOSSARY[category]}
