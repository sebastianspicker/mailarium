...
def _cached_detected_language(text: str) -> str | None:
    """Cache language decisions by text prefix so multilingual senders are not conflated."""
...
def reset_model_cache() -> None:
    """Clear loaded spaCy models and language decisions for deterministic reconfiguration."""
    global _nlp_load_attempted
    _nlp_models.clear()
    _nlp_load_attempted = False
