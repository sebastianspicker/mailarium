...
def _url_rows(text: str):
    """Emit URL entities with exact source offsets."""
...
def _simple_regex_rows(text: str, pattern, entity_type: str):
    """Emit regex matches as normalized entity rows with offsets."""
...
def _phone_rows(text: str):
    """Emit phone-number entities after trimming surrounding punctuation."""
...
def _domain_rows(sender_email: str | None):
    """Emit domain entities while excluding spans already captured as URLs."""
