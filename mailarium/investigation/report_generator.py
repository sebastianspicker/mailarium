...
class ReportGenerator:
    ...
    def __init__(self, email_db: ArchiveDatabase) -> None:
        """Bind the database supplying report metrics and rendered summaries."""
        self._db = email_db
        self.last_warnings: list[str] = []

    def _record_warning(self, message: str, *, exc: Exception | None = None) -> None:
        """Append a recoverable rendering warning and log its originating exception."""
    ...
    def _write_report(output_path: str, html: str) -> None:
        """Create a validated parent directory and write the rendered HTML report."""
        try:
