...
from .qa_eval_bootstrap import bootstrap_question_set, default_bootstrap_questions_path
...
async def run_evaluation(
    *,
    ...
    """Run captured or live QA evaluation through the implementation-layer dependency seam."""
    _impl._resolve_live_retriever = _resolve_live_retriever
