"""Select and normalize clean message bodies across text, HTML, and quoted surfaces."""
...
from .body_boundaries import strip_quoted_content as _strip_quoted_content
from .body_boundaries import strip_signature as _strip_signature
...
from .html_text import strip_legal_disclaimer_tail as _strip_legal_disclaimer_tail
