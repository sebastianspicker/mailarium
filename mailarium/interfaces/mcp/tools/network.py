...
def register(mcp: Any, deps: ToolDepsProto) -> None:
    ...
    _register_contacts_tool(mcp, deps)
    _register_network_analysis_tool(mcp, deps)
    _register_relationship_paths_tool(mcp, deps)
    _register_shared_recipients_tool(mcp, deps)
    _register_coordinated_timing_tool(mcp, deps)
    _register_relationship_summary_tool(mcp, deps)


def _register_contacts_tool(mcp: Any, deps: ToolDepsProto) -> None:
    """Register the contacts tool without coupling it to sibling tool modules."""
...
def _register_network_analysis_tool(mcp: Any, deps: ToolDepsProto) -> None:
    """Register the network analysis tool without coupling it to sibling tool modules."""
...
def _register_relationship_paths_tool(mcp: Any, deps: ToolDepsProto) -> None:
    """Register the relationship paths tool without coupling it to sibling tool modules."""
...
def _register_shared_recipients_tool(mcp: Any, deps: ToolDepsProto) -> None:
    """Register the shared recipients tool without coupling it to sibling tool modules."""
...
def _register_coordinated_timing_tool(mcp: Any, deps: ToolDepsProto) -> None:
    """Register the coordinated timing tool without coupling it to sibling tool modules."""
...
def _register_relationship_summary_tool(mcp: Any, deps: ToolDepsProto) -> None:
    """Register the relationship summary tool without coupling it to sibling tool modules."""
