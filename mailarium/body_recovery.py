...
@dataclass(frozen=True)
class _BodySurfaces:
    """Collect the visible, source, and recovered forms of an email body."""
...
def _initial_body_state(
    ...
    """Classify the body before fallback recovery is attempted."""
...
def _recover_body(reason: str, surfaces: _BodySurfaces, raw_text: str, raw_html: str, email_type: str) -> BodyRecovery:
    """Choose a safe fallback body for source shells, HTML shells, or metadata-only replies."""
...
def _recovery_summary(reason: str, raw_text: str, raw_html: str, email_type: str) -> BodyRecovery | None:
    """Describe which body surface was selected and why recovery was needed."""
