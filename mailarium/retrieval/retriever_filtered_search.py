...
if TYPE_CHECKING:
    from .retriever import SearchEngine, SearchResult, _SearchFilters, _SearchPlan
    from .retriever_models import SearchRequest
...
def prepare_filtered_search_impl(retriever: SearchEngine, request: SearchRequest) -> tuple[_SearchPlan | None, _SearchFilters]:
...
def _normalized_filters(request: SearchRequest, allowed_uids: set[str] | None) -> _SearchFilters:
