"""In-memory inverted index for provider-neutral learned sparse vectors."""
...
class SparseIndex:
    ...
    def __init__(self) -> None:
        """Initialize empty postings guarded for atomic rebuilds."""
    ...
    def is_built(self) -> bool:
        """Report whether an index snapshot is ready for searching."""
        return self._built

    @property
    def doc_count(self) -> int:
        """Return the number of documents in the active index snapshot."""
    ...
    def build_from_db(
        ...
        *,
        ...
        """Stream stored sparse vectors from SQLite into a fresh in-memory index."""
    ...
    def build_from_iterable(self, vectors) -> None:
        ...
        self._install_vectors(vectors)

    def _install_vectors(self, vectors) -> None:
        """Build temporary postings from an iterable and atomically publish them."""
