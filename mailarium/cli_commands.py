...
def _cmd_admin(
    ...
    runtime_family.cmd_admin_impl(args, retriever)
...
def _get_email_db():
    ...
    """
    return runtime_family.get_email_db_impl(
...
def _run_analytics_command(args: argparse.Namespace) -> None:
    ...
    Args:
        args: Parsed command-line arguments.
    """
    runtime_family.run_analytics_command_impl(
        args,
...
def _run_suggest() -> None:
    ...
    Delegates to the compat family implementation.
    """
    runtime_family.run_suggest_impl(_get_email_db)
...
def _run_generate_report(output_path: str) -> None:
    ...
    """
    runtime_family.run_generate_report_impl(_get_email_db, output_path)
...
def _run_export_thread(conversation_id: str, fmt: str, output_path: str | None) -> None:
    ...
    """
    runtime_family.run_export_thread_impl(_get_email_db, conversation_id, fmt, output_path)
...
def _run_export_email(uid: str, fmt: str, output_path: str | None) -> None:
    ...
    Args:
        ...
        output_path: Optional path for the exported output.
    """
    runtime_family.run_export_email_impl(_get_email_db, uid, fmt, output_path)
...
def _run_browse(
    ...
    """
    runtime_family.run_browse_impl(_get_email_db, offset, limit, folder, sender)
...
def _run_evidence_list(category: str | None, min_relevance: int | None) -> None:
    ...
    """
    runtime_family.run_evidence_list_impl(_get_email_db, _print_rich_or_plain, category, min_relevance)
...
def _run_evidence_export(
    ...
    Args:
        ...
        min_relevance: Optional minimum relevance threshold.
    """
    runtime_family.run_evidence_export_impl(_get_email_db, output_path, fmt, category, min_relevance)
...
def _run_evidence_stats() -> None:
    ...
    Delegates to the compat family implementation.
    """
    runtime_family.run_evidence_stats_impl(_get_email_db, _print_rich_or_plain)
...
def _run_evidence_verify() -> None:
    ...
    Delegates to the compat family implementation.
    """
    runtime_family.run_evidence_verify_impl(_get_email_db)
...
def _run_dossier(
    ...
    Args:
        ...
        min_relevance: Optional minimum relevance threshold.
    """
    runtime_family.run_dossier_impl(_get_email_db, output_path, fmt, category, min_relevance)
...
def _run_custody_chain() -> None:
    ...
    Delegates to the compat family implementation.
    """
    runtime_family.run_custody_chain_impl(_get_email_db, _print_rich_or_plain)
...
def _run_provenance(email_uid: str) -> None:
    ...
    """
    runtime_family.run_provenance_impl(_get_email_db, email_uid)
...
def _run_export_network(output_path: str) -> None:
    ...
    """
    runtime_family.run_export_network_impl(_get_email_db, output_path)
...
def _run_generate_training_data(output_path: str) -> None:
    ...
    """
    runtime_family.run_generate_training_data_impl(_get_email_db, output_path)
