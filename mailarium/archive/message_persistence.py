"""Persistence helpers for ArchiveDatabase write paths."""
...
def build_email_insert_row(db, email: Message, ingestion_run_id: int | None):
    ...
    Args:
        db: The ArchiveDatabase instance (provides compute_content_hash).
...
def persist_single_related_rows(cur, db, email: Message, *, infer_parent: bool = True) -> None:
...
def _collect_batch_related_rows(cur: Any, email: Message, rows: _BatchRows) -> None:
...
def insert_email_impl(db, email: Message, *, ingestion_run_id: int | None = None) -> bool:
    ...
    Args:
        db: The ArchiveDatabase instance.
        email: The Message object to insert.
        ingestion_run_id: Optional ingestion run identifier.
...
def insert_emails_batch_impl(
    ...
    *,
    ...
    Args:
        db: The ArchiveDatabase instance.
        emails: List of Message objects to insert.
        ingestion_run_id: Optional ingestion run identifier.
