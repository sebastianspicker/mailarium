...
from mailarium.model.body_boundaries import strip_quoted_content, strip_signature
from mailarium.model.chunks import EmailChunk
from mailarium.model.message_formatting import build_email_header
...
def chunk_email(email_dict: dict) -> list[EmailChunk]:
    ...
    Args:
        email_dict: Output of ParsedMessage.to_dict()
