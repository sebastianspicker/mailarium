...
from mailarium.model.rfc2822 import _normalize_date, _parse_int
...
def parse_olm_archive_impl(
    ...
    *,
    ...
    max_xml_bytes: int,
    logger: Logger,
    parse_email_xml_fn: Callable[[bytes, str], ParsedMessage | None],
...
def _parse_archive_member(
    ...
    logger: Logger,
    parser: Callable[[bytes, str], ParsedMessage | None],
...
def parse_email_xml_impl(
    ...
    *,
    ...
    build_parsed_email_from_parts_fn: Callable[[ParsedEmailParts, ParsedEmailEnrichments], ParsedMessage],
) -> ParsedMessage | None:
