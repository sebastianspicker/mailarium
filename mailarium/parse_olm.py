...
class Email:
    ...
    def body_kind(self) -> str:
        """Expose the body classification derived from normalized source content."""
    ...
    def body_recovery(self) -> BodyRecovery:
        """Classify recoverable and empty-body states from raw and normalized message surfaces."""
    ...
    def to_dict(self) -> dict:
        """Expose Email as JSON-compatible data for report consumers."""
        return {
            "uid": self.uid,
...
def parse_olm(
    ...
    Yields:
        Email objects for valid message XML entries encountered before archive
