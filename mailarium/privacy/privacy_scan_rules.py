...
TRACKED_FORBIDDEN_PATH_PATTERNS = (
    ...
    re.compile(r"(^|/)(?:live|prod(?:uction)?|staging|development|local)\.env$", re.IGNORECASE),
    ...
    re.compile(r"(^|/)(?:secrets\.toml|credentials(?:\.[^/]*)?|private[-_]?key(?:\.[^/]*)?)$", re.IGNORECASE),
...
TEXT_EXEMPT_PATHS = {
    "scripts/release/privacy_scan.py",
    "mailarium/privacy/privacy_scan_rules.py",
}
