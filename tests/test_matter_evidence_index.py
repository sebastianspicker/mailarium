...
def test_build_matter_evidence_index_adds_structured_exhibit_reliability_layers():
    payload = _fixture_test_build_matter_evidence_index_adds_structured_exhibit_reliability_layers_payload()
...
def test_build_matter_evidence_index_surfaces_adverse_action_review_hints() -> None:
    payload = _fixture_test_build_matter_evidence_index_surfaces_adverse_action_review_hints_payload()
...
def test_build_matter_evidence_index_uses_document_author_and_recipients_when_available() -> None:
    payload = _fixture_test_build_matter_evidence_index_uses_document_author_and_recipients_when_available_payload()
...
def test_build_matter_evidence_index_uses_entity_occurrence_issue_tag_basis() -> None:
    payload = _fixture_test_build_matter_evidence_index_uses_entity_occurrence_issue_tag_basis_payload()
...
def test_build_matter_evidence_index_links_manifest_only_document_to_email_findings_and_identities() -> None:
    payload = _fixture_test_build_matter_evidence_index_links_manifest_only_document_to_email_findings_and_identities_payload()
...
def _fixture_test_build_matter_evidence_index_adds_structured_exhibit_reliability_layers_payload():
    return build_matter_evidence_index(
        case_bundle={
            "scope": {
        ...
        multi_source_case_bundle=_fixture_test_build_matter_evidence_index_adds_structured_exhibit_reliability_layers_payload_part_0(),
        master_chronology={
            "summary": {
...
def _fixture_test_build_matter_evidence_index_surfaces_adverse_action_review_hints_payload():
    return build_matter_evidence_index(
...
def _fixture_test_build_matter_evidence_index_uses_document_author_and_recipients_when_available_payload():
    return build_matter_evidence_index(
...
def _fixture_test_build_matter_evidence_index_uses_entity_occurrence_issue_tag_basis_payload():
    return build_matter_evidence_index(
        case_bundle={"scope": {"employment_issue_tracks": []}},
        multi_source_case_bundle={
            "summary": {"source_type_counts": {"email": 1}},
...
def _fixture_test_build_matter_evidence_index_links_manifest_only_document_to_email_findings_and_identities_payload():
    return build_matter_evidence_index(
...
def _fixture_test_build_matter_evidence_index_adds_structured_exhibit_reliability_layers_payload_part_0():
    return {
