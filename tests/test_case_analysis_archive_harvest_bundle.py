...
from ._archive_harvest_bundle_cases import (
    ATTACHMENT_EVIDENCE_BANK,
    DENSE_EVIDENCE_BANK,
    EXPANDED_EVIDENCE_BANK,
    MIXED_SOURCE_BUNDLE_INPUT,
    MIXED_SOURCE_SUMMARY_INPUT,
    NARROW_LANE_DIAGNOSTICS,
...
async def test_build_archive_harvest_bundle_widens_dense_corpus_after_coverage_failure(monkeypatch) -> None:
    ...
    def fake_search_across_query_lanes(  # pylint: disable=too-many-arguments,too-many-positional-arguments
        *,
        retriever,
        search_kwargs,
        query_lanes,
        ...
        if len(calls) == 1:
            evidence_bank = SPARSE_EVIDENCE_BANK
        else:
            evidence_bank = DENSE_EVIDENCE_BANK
        return (
            [],
        ...
        if len(calls) == 1:
            return (
                ...
                ],
                {
                    ...
                    "selected_result_count": 0,
                    "evidence_bank": SINGLE_RESULT_EVIDENCE_BANK,
                    "evidence_results": [],
                },
            )
        return (
            ...
            [{"lane_id": f"lane_{index}", "query": lane, "result_count": 1} for index, lane in enumerate(query_lanes, start=1)],
            {
                ...
                "selected_result_count": 0,
                "evidence_bank": EXPANDED_EVIDENCE_BANK,
                "evidence_results": [],
            },
        )
        ...
        *,
        ...
        return (
            ...
            [{"lane_id": "lane_1", "result_count": 2}],
            {
                ...
                "selected_result_count": 0,
                "evidence_bank": ATTACHMENT_EVIDENCE_BANK,
                "evidence_results": [],
            },
        )
    ...
    def fake_search_across_query_lanes(**kwargs):
        return (
            ...
            [{"lane_id": "lane_1", "result_count": 1}],
            {
                ...
                "candidate_pool_count": 1,
                "selected_result_count": 0,
                "evidence_bank": SINGLE_BODY_EVIDENCE_BANK,
                "evidence_results": [],
            },
        )
...
def test_augment_mixed_source_harvest_summary_relaxes_email_gap_reasons_for_manifest_primary_runs() -> None:
    ...
    summary = augment_mixed_source_harvest_summary(
        summary=MIXED_SOURCE_SUMMARY_INPUT,
        multi_source_case_bundle=MIXED_SOURCE_BUNDLE_INPUT,
        params=params,
    )
