"""Ensures schema initialization passes its live connection, cursor, and version metadata to migrations."""
...
from mailarium import db_schema


def test_init_schema_delegates_migrations_to_extracted_module() -> None:
    conn = sqlite3.connect(":memory:")
    try:
        with patch("mailarium.db_schema_migrations.apply_pending_migrations_impl") as mock_impl:
