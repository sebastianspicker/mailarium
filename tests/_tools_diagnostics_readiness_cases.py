# ruff: noqa: I001
"""MCP diagnostics readiness summaries across captured and live evaluation reports."""
...
from .helpers.diagnostics_fakes import answer_task_readiness, standard_core_summary, write_diagnostics_report, write_json_artifact
...
class TestDiagnostics:
    ...
    async def test_diagnostics_includes_answer_task_readiness_from_eval_report(self, monkeypatch, tmp_path):
        ...
        write_diagnostics_report(
            ...
            standard_core_summary(
                bucket_counts={"attachment_lookup": 2, "fact_lookup": 4, "thread_process": 2, "ambiguity_stress": 2},
        ...
        readiness = await answer_task_readiness(monkeypatch, [report_path])
    ...
    async def test_diagnostics_prefers_thread_metrics_from_specialized_report(self, monkeypatch, tmp_path):
        ...
        write_diagnostics_report(core_report, standard_core_summary())
        write_diagnostics_report(
            inferred_report,
            {
                "thread_group_id_match": {"scorable": 2, "passed": 2, "failed": 0},
        ...
        readiness = await answer_task_readiness(monkeypatch, [core_report, inferred_report])
    ...
    async def test_diagnostics_prefers_live_thread_metrics_over_captured_specialized_report(self, monkeypatch, tmp_path):
        ...
        write_diagnostics_report(
            inferred_live_report,
            {
                "thread_group_id_match": {"scorable": 2, "passed": 1, "failed": 1},
                "thread_group_source_match": {"scorable": 2, "passed": 1, "failed": 1},
            },
        )
        readiness = await answer_task_readiness(monkeypatch, [core_report, inferred_captured_report, inferred_live_report])
    ...
    async def test_diagnostics_includes_natural_inferred_thread_prevalence(self, monkeypatch, tmp_path):
        ...
        readiness = await answer_task_readiness(monkeypatch, [core_report], prevalence_paths=[prevalence_report])
    ...
    async def test_diagnostics_prefers_long_thread_metrics_from_specialized_live_report(self, monkeypatch, tmp_path):
        ...
        readiness = await answer_task_readiness(monkeypatch, [core_report, long_thread_report])
    ...
    async def test_diagnostics_prefers_attachment_ocr_metrics_from_specialized_report(self, monkeypatch, tmp_path):
        ...
        write_diagnostics_report(
            attachment_ocr_report,
            {"attachment_ocr_text_evidence_success": {"scorable": 2, "passed": 1, "failed": 1}},
        )
        readiness = await answer_task_readiness(monkeypatch, [core_report, attachment_ocr_report])
