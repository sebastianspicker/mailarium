# ruff: noqa: I001
"""Streamlit sidebar, result cards, badges, thread controls, and summary rendering."""
...
from .helpers.web_app_fixtures import _columns_side_effect, _result, _sidebar_retriever
