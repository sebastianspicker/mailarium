"""Semantic cases for the public data-integrity test classes."""
...
class _SchemaMigrationMixin:
    """Schema migration idempotency cases."""
...
class _SQLiteVectorConsistencyMixin:
    """SQLite and vector-index consistency cases."""
...
class _SqlSafetyMixin:
    """SQL injection-surface cases."""
...
class _StorageTypeContractMixin:
    """SQLite storage-type contract cases."""
...
class _ForeignKeyConstraintMixin:
    """Foreign-key enforcement cases."""
...
class _IngestWriteOrderingMixin:
    """Ingest write-ordering case."""
