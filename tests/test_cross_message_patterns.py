...
def test_build_case_patterns_summarizes_recurrence_by_behavior_taxonomy_and_thread():
    patterns = _fixture_test_build_case_patterns_summarizes_recurrence_by_behavior_taxonomy_and_thread_patterns()
...
def test_build_case_patterns_requires_real_target_linkage_for_targeted_recurrence() -> None:
    patterns = _fixture_test_build_case_patterns_requires_real_target_linkage_for_targeted_recurrence_patterns()
...
def test_build_case_patterns_keeps_one_off_events_isolated():
    patterns = _fixture_test_build_case_patterns_keeps_one_off_events_isolated_patterns()
...
def test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews():
    patterns = _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns()
...
def test_build_case_patterns_coordination_windows_handle_mixed_timezone_dates() -> None:
    patterns = _fixture_test_build_case_patterns_coordination_windows_handle_mixed_timezone_dates_patterns()
...
def test_build_case_patterns_uses_event_records_for_sequence_signals() -> None:
    patterns = _fixture_test_build_case_patterns_uses_event_records_for_sequence_signals_patterns()
...
def _fixture_test_build_case_patterns_summarizes_recurrence_by_behavior_taxonomy_and_thread_patterns():
    return build_case_patterns(
        candidates=[
            {
                "uid": "u1",
...
def _fixture_test_build_case_patterns_requires_real_target_linkage_for_targeted_recurrence_patterns():
    return build_case_patterns(
        candidates=[
            {
                "uid": "u1",
...
def _fixture_test_build_case_patterns_keeps_one_off_events_isolated_patterns():
    return build_case_patterns(
        candidates=[
            {
                "uid": "u1",
...
def _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns():
    return build_case_patterns(
        candidates=_fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns_part_0(),
        target_actor_id="actor-target",
    )


def _fixture_test_build_case_patterns_coordination_windows_handle_mixed_timezone_dates_patterns():
    return build_case_patterns(
        candidates=[
            {
                "uid": "u1",
...
def _fixture_test_build_case_patterns_uses_event_records_for_sequence_signals_patterns():
    return build_case_patterns(
        candidates=[
            {
                "uid": "u-event-1",
...
def _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns_part_0():
    return [
        {
            "uid": "u1",
        ...
        _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns_part_0_part_final(),
        {
            "uid": "u3",
        ...
        _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns_part_0_part_next(),
        {
            "uid": "u6",
...
def _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns_part_0_part_next():
    return {
        "uid": "u5",
        ...
        "message_findings": {
            "authored_text": {
                ...
                "omissions_or_process_signals": [{"signal": "target_absent_from_visible_recipients", "summary": "placeholder"}],
                "communication_classification": {
                    "primary_class": "controlling",
                    "applied_classes": ["controlling"],
                },
...
def _fixture_test_build_case_patterns_adds_corpus_level_response_and_coordination_reviews_patterns_part_0_part_final():
    return {
        "uid": "u2",
